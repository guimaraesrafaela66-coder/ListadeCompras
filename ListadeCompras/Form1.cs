...
namespace ListadeCompras
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdicionar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    libCompras.Items.Add(txbProduto);
                    MessageBox.Show($"{txbProduto.Text} foi adicionado na listade compras!",
                        "Show!", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    // Retornar o txb.Produto à cor normal:
        ...
        {
            // Perguntar se4 realmente quer apagar:
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (libCompras.SelectedIndex == -1)
            {
                MessageBox.Show("Selecione um item para remover!",
                    "Erroo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else

            {
                // Salvar temporariamente o nome de item que será removido:
                string itemRemovido = libCompras.SelectedItem.ToString();

                // Rempver o item selecionado:
